    ...
    <div class="member-auth__frame">
      <div class="member-auth__panel">
        ...
        <form class="member-auth__form" @submit.prevent="submit">
          ...
          <input v-model.trim="form.referralCode" type="text" placeholder="Mã mời bắt buộc" />
...
async function submit() {
  ...
  if (!form.username || !form.password || !form.confirmPassword || !form.withdrawPassword || !form.referralCode) {
